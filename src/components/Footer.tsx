    ...
    <footer className="bg-slate-100 dark:bg-[#06080d] border-t border-slate-205/60 dark:border-slate-900 py-10 px-4 md:px-8 text-xs text-slate-500 dark:text-slate-450 transition-colors duration-300">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6" id="footer-container">
        ...
        <div className="flex flex-col items-center sm:items-start text-center sm:text-left gap-2">
          <button
            onClick={onOpenAdmin}
            className="font-black text-slate-700 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 cursor-pointer text-left transition-colors font-sans hover:underline decoration-indigo-500 decoration-2 underline-offset-4"
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="w-8 h-8 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-indigo-650 dark:hover:text-indigo-400 transition-all text-slate-505 dark:text-slate-400 shadow-xs"
          >
